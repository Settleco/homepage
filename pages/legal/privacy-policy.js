...
export default function PrivacyPolicy(){
    ...
    <div className="w-7/12 mx-auto">
        ...
        <p>This Privacy Policy applies to our website, and its associated subdomains (collectively, our “Service”)
            alongside our application, SettleCo. By accessing or using our Service, you signify that you have read,
        ...
        <p>To help explain things as clearly as possible in this Privacy Policy, every time any of these terms are
            ...
            <ul>
                ...
                <li className={style.li}>IP address: Every device connected to the Internet is assigned a number known as an Internet
                    ...
                    often be used to identify the location from which a device is connecting to the Internet.
                </li>
                <li className={style.li}>Personnel: refers to those individuals who are employed by SettleCo or are under contract to perform
                ...
                <li className={style.li}>Service: refers to the service provided by SettleCo as described in the relative terms (if
        ...
        <p>Any of the information we collect from you may be used in one of the following ways:
            <ul>
                <li className={style.li}>To personalize your experience (your information helps us to better respond to your individual
                    needs)
                </li>
        ...
        <p>SettleCo will collect End User Data necessary to provide the SettleCo services to our customers.</p>
        <p>End users may voluntarily provide us with information they have made available on social media websites. If
        ...
        <p>We receive some information from the third parties when you contact us. For example, when you submit your
            ...
            party that provides automated fraud detection services to SettleCo. We also occasionally collect information
        ...
        <p>We may share portions of our log file data, including IP addresses, for analytics purposes with third parties
            ...
            aggregate information about our advertising and what you see on the website and then provide auditing,
        ...
        <p>We keep your information only so long as we need it to provide SettleCo to you and fulfill the purposes
        ...
        <p>If you are a SettleCo worker or applicant, we collect information you voluntarily provide to us. We use the
        ...
        <p>We reserve the right to transfer information to a third party in the event of a sale, merger or other
            ...
            petition in bankruptcy, reorganization or similar proceeding, provided that the third party agrees to adhere
        ...
        <p>SettleCo uses "Cookies" to identify the areas of our website that you have visited. A Cookie is a small piece
        ...
        <h1 className={style.h1}>Kids' Privacy</h1>
        ...
        <ul>
            ...
            <br />
                <li className={style.li}>Local Storage
                    <br /><br />
                        <p>Local Storage sometimes known as DOM storage, provides web apps with methods and protocols
                ...
                <br />
                    <li className={style.li}>Sessions
                        <br /><br />
                            <p>$elnombre uses "Sessions" to identify the areas of our website that you have visited. A
        ...
        <p>The GDPR is relevant to any globally operating company and not just the EU-based businesses and EU residents.
            ...
            GDPR controls as our baseline standard for all our operations worldwide.</p>
        ...
        <h1 className={style.h1}>Individual Data Subject's Rights - Data Access, Portability and Deletion</h1>
        ...
        <h1 className={style.h1}>California Residents</h1>
